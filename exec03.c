...
/*   Updated: 2021/04/10 01:22:46 by hde-camp         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	int res01 = ft_str_is_numeric(str01);
	int res02 = ft_str_is_numeric(str02);
	int res03 = ft_str_is_numeric(str03);
	int res04 = ft_str_is_numeric(str04);
	int res05 = ft_str_is_numeric(str05);
	int res06 = ft_str_is_numeric(str06);
	int res07 = ft_str_is_numeric(str07);
	

	printf("--------------------------------------EX03--------------------------------------\n");
	printf("-------------------------------------INICIO-------------------------------------\n");
	printf("---------Imprimir 1 somente strings inteiramente compostas por numeros----------\n");
	printf("================================================================================\n");
