...
/*   Updated: 2021/04/10 01:38:53 by hde-camp         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(void)
{
	...
	int res01 = ft_str_is_uppercase(str01);
	int res02 = ft_str_is_uppercase(str02);
	int res03 = ft_str_is_uppercase(str03);
	int res04 = ft_str_is_uppercase(str04);
	int res05 = ft_str_is_uppercase(str05);
	int res06 = ft_str_is_uppercase(str06);
	int res07 = ft_str_is_uppercase(str07);
	
	printf("--------------------------------------EX05--------------------------------------\n");	
	printf("-------------------------------------INICIO-------------------------------------\n");
	printf("------1 apenas para strings compostas inteiramente de caracteres entre A-Z------\n");
	printf("================================================================================\n");
